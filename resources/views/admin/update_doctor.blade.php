                    ...
                    <div class="card">
                     ...
                     @endif
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text"  class="form-control" id="basicInput" value="{{ $doctor->name }}" name="name"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="helpInputTop" name="phone" value="{{ $doctor->phone }}">
                                    </div>
                                 ...
                                 <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="helpInputback" placeholder="Write a room No" name="room" value="{{ $doctor->room }}">
                                </div>

                                    <div class="form-group">
                                        <label for="helpInputTop">Change Doctor Image</label>
                                        <input type="file" class="form-control" id="helpInputTop" name="image"  value="{{ $doctor->image }}">
                                        <img src="doctorimage/{{$doctor->image}}" style="border-radius:50%;" height="100" width="100">
                                    </div>                                
